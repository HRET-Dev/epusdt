...
func defaultRpcNodes() []mdb.RpcNode {
	defaults := []mdb.RpcNode{
		...
		{Network: mdb.NetworkBsc, Url: "wss://bsc.publicnode.com", Type: mdb.RpcNodeTypeWs, Weight: 1, Enabled: true, Purpose: mdb.RpcNodePurposeGeneral, Status: mdb.RpcNodeStatusUnknown},
		{Network: mdb.NetworkBsc, Url: "wss://rpc.ankr.com/bsc/ws", Type: mdb.RpcNodeTypeWs, Weight: 1, Enabled: true, Purpose: mdb.RpcNodePurposeGeneral, Status: mdb.RpcNodeStatusUnknown},
